...
static const char *const mlc_date = "2026-07-09 11:48:15";
...
static const struct mems_conf_result mlc_results_0_0[] = {
    { .code = 0x01, .label = "flicker" },
    { .code = 0x02, .label = "doublepinch" },
    { .code = 0x03, .label = "sidetap" },
    { .code = 0x04, .label = "null" },
    { .code = 0x05, .label = "pinchhold" }
};
...
static const struct mems_conf_mlc_identifier mlc_mlc_identifiers_0[] = {
    { .fifo_tag = 0x1C, .id = 0x03CC, .label = "F1_PEAK_TO_PEAK_GYR_Y" },
    { .fifo_tag = 0x1C, .id = 0x03CE, .label = "F2_MINIMUM_ACC_Y" },
    { .fifo_tag = 0x1C, .id = 0x03D0, .label = "F3_PEAK_TO_PEAK_GYR_X" },
    { .fifo_tag = 0x1C, .id = 0x03D2, .label = "F4_MAXIMUM_GYR_Y" },
    { .fifo_tag = 0x1C, .id = 0x03D4, .label = "F5_MINIMUM_GYR_X" },
    { .fifo_tag = 0x1C, .id = 0x03D6, .label = "F6_VARIANCE_GYR_X" },
    { .fifo_tag = 0x1C, .id = 0x03D8, .label = "F7_PEAK_TO_PEAK_ACC_Y" },
    { .fifo_tag = 0x1C, .id = 0x03DA, .label = "F8_MAXIMUM_GYR_Z" },
    { .fifo_tag = 0x1C, .id = 0x03DC, .label = "F9_PEAK_TO_PEAK_ACC_Z" },
    { .fifo_tag = 0x1C, .id = 0x03DE, .label = "F10_VARIANCE_GYR_Y" },
    { .fifo_tag = 0x1C, .id = 0x03E0, .label = "F11_ENERGY_GYR_Y" },
    { .fifo_tag = 0x1C, .id = 0x03E2, .label = "F12_MAXIMUM_GYR_X" },
    { .fifo_tag = 0x1C, .id = 0x03E4, .label = "F13_VARIANCE_ACC_Y" },
    { .fifo_tag = 0x1C, .id = 0x03E6, .label = "F14_MAXIMUM_ACC_Y" },
    { .fifo_tag = 0x1C, .id = 0x03E8, .label = "F15_MINIMUM_GYR_Y" }
};
