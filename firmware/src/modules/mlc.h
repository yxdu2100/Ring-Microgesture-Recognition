...
static const char *const mlc_date = "2026-07-16 13:33:57";
...
static const struct mems_conf_mlc_identifier mlc_mlc_identifiers_0[] = {
    ...
    { .fifo_tag = 0x1C, .id = 0x03C6, .label = "F2_PEAK_TO_PEAK_GYR_X" },
    { .fifo_tag = 0x1C, .id = 0x03C8, .label = "F3_MINIMUM_ACC_Y" },
    { .fifo_tag = 0x1C, .id = 0x03CA, .label = "F4_PEAK_TO_PEAK_GYR_Y" },
    { .fifo_tag = 0x1C, .id = 0x03CC, .label = "F5_ABS_MEAN_GYR_V" },
    { .fifo_tag = 0x1C, .id = 0x03CE, .label = "F6_PEAK_TO_PEAK_ACC_Y" },
    { .fifo_tag = 0x1C, .id = 0x03D0, .label = "F7_MAXIMUM_GYR_Y" },
    { .fifo_tag = 0x1C, .id = 0x03D2, .label = "F8_VARIANCE_ACC_Y" },
    { .fifo_tag = 0x1C, .id = 0x03D4, .label = "F9_ENERGY_GYR_X" },
    { .fifo_tag = 0x1C, .id = 0x03D6, .label = "F10_ABS_MEAN_ACC_V" },
    { .fifo_tag = 0x1C, .id = 0x03D8, .label = "F11_ENERGY_ACC_X" },
    { .fifo_tag = 0x1C, .id = 0x03DA, .label = "F12_MINIMUM_ACC_X" },
    { .fifo_tag = 0x1C, .id = 0x03DC, .label = "F13_MINIMUM_ACC_Z" },
    { .fifo_tag = 0x1C, .id = 0x03DE, .label = "F14_MAXIMUM_GYR_X" },
    { .fifo_tag = 0x1C, .id = 0x03E0, .label = "F15_MEAN_GYR_Y" }
};
