...
from train_hdc.train import train_hdc
...
def export_header(windows, splits: dict, out_path: Path, dim: int = 2048) -> None:
    if dim != 2048:
    ...
    with out_path.open("w") as f:
        ...
        f.write("// word order matches clf_hdc.c: bit 0 is LSB, timestep permutation rotates whole words forward.\n")
...
def main() -> None:
    ...
    export_header(windows, splits, Path(args.out))
