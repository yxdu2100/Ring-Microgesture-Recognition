...
static const char *const mlc_date = "2026-07-12 17:24:15";
...
static const struct mems_conf_mlc_identifier mlc_mlc_identifiers_0[] = {
    ...
    { .fifo_tag = 0x1C, .id = 0x03CA, .label = "F3_PEAK_TO_PEAK_ACC_Y" },
    { .fifo_tag = 0x1C, .id = 0x03CC, .label = "F4_MINIMUM_ACC_Y" },
    { .fifo_tag = 0x1C, .id = 0x03CE, .label = "F5_VARIANCE_GYR_X" },
    { .fifo_tag = 0x1C, .id = 0x03D0, .label = "F6_ABS_MEAN_GYR_V" },
    { .fifo_tag = 0x1C, .id = 0x03D2, .label = "F7_MAXIMUM_ACC_Y" },
    { .fifo_tag = 0x1C, .id = 0x03D4, .label = "F8_MEAN_GYR_Y" },
    { .fifo_tag = 0x1C, .id = 0x03D6, .label = "F9_ENERGY_GYR_X" },
    { .fifo_tag = 0x1C, .id = 0x03D8, .label = "F10_VARIANCE_ACC_Y" },
    { .fifo_tag = 0x1C, .id = 0x03DA, .label = "F11_PEAK_TO_PEAK_GYR_X" },
    { .fifo_tag = 0x1C, .id = 0x03DC, .label = "F12_VARIANCE_GYR_Y" },
    { .fifo_tag = 0x1C, .id = 0x03DE, .label = "F13_MAXIMUM_GYR_X" },
    { .fifo_tag = 0x1C, .id = 0x03E0, .label = "F14_ENERGY_GYR_Y" },
    { .fifo_tag = 0x1C, .id = 0x03E2, .label = "F15_MINIMUM_ACC_Z" }
};
